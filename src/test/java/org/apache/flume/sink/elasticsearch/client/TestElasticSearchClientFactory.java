...
public class TestElasticSearchClientFactory {
	...
	@Test
	public void shouldReturnRestClient() throws NoSuchClientTypeException, UnknownHostException {
		String[] hostNames = { "127.0.0.1" };
	...
	public void shouldThrowNoSuchClientTypeException() throws NoSuchClientTypeException, UnknownHostException {
		String[] hostNames = { "127.0.0.1" };
